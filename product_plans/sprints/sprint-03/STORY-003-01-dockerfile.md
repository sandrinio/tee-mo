...
ambiguity: "🟢 Low"
context_source: "Roadmap §3 ADR-019 (Coolify), ADR-026 (deploy pulled forward); Charter §6 (public HTTPS constraint); Codebase: backend/app/main.py, frontend/package.json, frontend/vite.config.ts"
actor: "Backend + Frontend Dev (Solo)"
complexity_label: "L2"
---
