 ...
 *
 * The page content is identical to the former TeamDetailPage component.
 * See the original file's JSDoc for full design decisions.
 *
 * Design decisions:
 ...
 *
 * Each WorkspaceCard is clickable: clicking the card body navigates to the
 * workspace detail page `/app/teams/$teamId/$workspaceId` (STORY-006-05).
 */
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-8">
      <div className="mx-auto max-w-2xl">
        ...
        {/* Workspace grid — each card links to the detail page */}
        {!isLoading && !error && workspaces && workspaces.length > 0 && (
