...
/**
 * Route for /app. validateSearch narrows the `slack_install` query param to
 * the SlackInstallState union so useSearch() returns typed data in AppContent.
 *
...
/**
 * AppPage — shell that wraps AppContent in ProtectedRoute.
 *
 * ProtectedRoute handles the spinner and redirect-to-login logic;
 * AppContent only renders when the user is authenticated.
 */
function AppPage() {
  return (
    <ProtectedRoute>
