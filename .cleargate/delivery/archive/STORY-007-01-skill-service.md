...
> **Ported from V-Bounce (shipped).** Original: `product_plans.vbounce-archive/archive/sprints/sprint-07/STORY-007-01-skill-service.md`. Shipped in sprint S-07, carried forward during ClearGate migration 2026-04-24.
...
- **R6**: Name validation is enforced in the service layer.
...
- `TOOL_CATALOG` validation (stripped)
